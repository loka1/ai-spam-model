...
Original file is located at
    https://colab.research.google.com/drive/1zHotL9IZkQzicncnCeIABgi0wZYZNTy4
"""
...
<br>
<br>
<img src="app/images/LSTM.png" width=400 height=400 />
...
plt.tight_layout()
plt.savefig('app/images/progression.png',bbox_inches='tight',dpi=400, pad_inches=0.1)
plt.show()
...
plt.savefig('app/images/confusion50.png',bbox_inches='tight',dpi=400, pad_inches=0.1)
plt.show()
...
plt.savefig('app/images/prob_dist.png',bbox_inches='tight',dpi=400, pad_inches=0.1)
...
ax2.annotate('FP=2.5% at Threshold 0.78', xy=point, xytext=(-90, 60),
            ...
            arrowprops=dict(
                arrowstyle='simple,tail_width=0.1,head_width=0.5,head_length=0.5',
                facecolor='black', shrinkB=circle_rad * 1))
plt.savefig('app/images/threshold.png',bbox_inches='tight',dpi=400, pad_inches=0.1)
plt.show();
...
plt.savefig('app/images/confusion77.png',bbox_inches='tight',dpi=400, pad_inches=0.1)
plt.show()
...
upload_file(
    path_or_fileobj="lstm-model/tokenizer.pkl",
...
upload_folder(
    repo_id="lokas/spam-emails-classifier",
    folder_path="logs",             # local folder
    path_in_repo="logs",            # remote folder path in repo
    repo_type="model"
)
...
upload_folder(
    repo_id="lokas/spam-emails-classifier",
    folder_path="/content/app/images",             # local folder
    path_in_repo="images",            # remote folder path in repo
    repo_type="model"
)
